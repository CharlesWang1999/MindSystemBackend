...
class FinalResult(models.Model):
    ...
    happiness_prob_imi = models.FloatField(null=True, blank=True)
    sadness_prob_imi = models.FloatField(null=True, blank=True)
    neutral_prob_imi = models.FloatField(null=True, blank=True)
    anger_prob_imi = models.FloatField(null=True, blank=True)
    surprise_prob_imi = models.FloatField(null=True, blank=True)
    disgust_prob_imi = models.FloatField(null=True, blank=True)
    fear_prob_imi = models.FloatField(null=True, blank=True)
